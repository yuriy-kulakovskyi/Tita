...
const Roles = props => {
  ...
  const setPrice = eventProps => {
    ...
    let product = {
      img: eventProps.nativeEvent.path[3].childNodes[0].lastChild.getAttribute('src'),
      title: eventProps.nativeEvent.path[3].childNodes[1].children[0].innerText,
      weight: eventProps.nativeEvent.path[3].childNodes[1].children[1].innerText + '/ккал',
      priceOfOne: productPrice,
      amount: parseInt(eventProps.nativeEvent.path[1].children[1].children[1].innerText),
      price: productPrice * parseInt(eventProps.nativeEvent.path[1].children[1].children[1].innerText)
    }

    fullPrice += productPrice * parseInt(eventProps.nativeEvent.path[1].children[1].children[1].innerText);

    props.updatePrice(parseInt(fullPrice));
    localStorage.setItem('fullPrice', parseInt(fullPrice) || 0);
